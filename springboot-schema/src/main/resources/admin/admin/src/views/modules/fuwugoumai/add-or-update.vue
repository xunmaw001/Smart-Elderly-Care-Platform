<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="下单编号" prop="xiadanbianhao">
            <el-input v-model="ruleForm.xiadanbianhao" 
                placeholder="下单编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiadanbianhao" label="下单编号" prop="xiadanbianhao">
              <el-input v-model="ruleForm.xiadanbianhao" 
                placeholder="下单编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="劳工姓名" prop="laogongxingming">
          <el-input v-model="ruleForm.laogongxingming" 
              placeholder="劳工姓名" clearable  :readonly="ro.laogongxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="劳工姓名" prop="laogongxingming">
              <el-input v-model="ruleForm.laogongxingming" 
                placeholder="劳工姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="老人住址" prop="laorenzhuzhi">
          <el-input v-model="ruleForm.laorenzhuzhi" 
              placeholder="老人住址" clearable  :readonly="ro.laorenzhuzhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="老人住址" prop="laorenzhuzhi">
              <el-input v-model="ruleForm.laorenzhuzhi" 
                placeholder="老人住址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='xiadanbianhao'){
            this.ruleForm.xiadanbianhao = obj[o];
	    this.ro.xiadanbianhao = true;
            continue;
          }
	    ...
	    this.ro.xiangmujiage = true;
          ...
          if(o=='laogongxingming'){
            this.ruleForm.laogongxingming = obj[o];
	    this.ro.laogongxingming = true;
            continue;
          }
          if(o=='laorenzhanghao'){
	    ...
	    this.ro.laorenshouji = true;
          ...
          if(o=='laorenzhuzhi'){
            this.ruleForm.laorenzhuzhi = obj[o];
	    this.ro.laorenzhuzhi = true;
            continue;
          }
          if(o=='yuyueshijian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.laorenzhanghao!=''&&json.laorenzhanghao){
                this.ruleForm.laorenzhanghao = json.laorenzhanghao
	    		this.ro.laorenzhanghao = true;
		}
		if(json.laorenxingming!=''&&json.laorenxingming){
                this.ruleForm.laorenxingming = json.laorenxingming
	    		this.ro.laorenxingming = true;
		}
		if(json.laorenshouji!=''&&json.laorenshouji){
                this.ruleForm.laorenshouji = json.laorenshouji
	    		this.ro.laorenshouji = true;
		}
		if(json.laorenzhuzhi!=''&&json.laorenzhuzhi){
                this.ruleForm.laorenzhuzhi = json.laorenzhuzhi
	    		this.ro.laorenzhuzhi = true;
		}
        } else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `fuwugoumai/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.fuwugoumaiCrossAddOrUpdateFlag = false;
						 this.parent.search();
