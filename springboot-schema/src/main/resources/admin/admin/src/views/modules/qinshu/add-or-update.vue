<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="亲属姓名" prop="qinshuxingming">
          <el-input v-model="ruleForm.qinshuxingming" 
              placeholder="亲属姓名" clearable  :readonly="ro.qinshuxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="亲属姓名" prop="qinshuxingming">
              <el-input v-model="ruleForm.qinshuxingming" 
                placeholder="亲属姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="与老人关系" prop="yulaorenguanxi">
          <el-input v-model="ruleForm.yulaorenguanxi" 
              placeholder="与老人关系" clearable  :readonly="ro.yulaorenguanxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="与老人关系" prop="yulaorenguanxi">
              <el-input v-model="ruleForm.yulaorenguanxi" 
                placeholder="与老人关系" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	qinshuxingming : false,
	xingbie : false,
	lianxifangshi : false,
	yulaorenguanxi : false,
      },
      ruleForm: {
        laorenzhanghao: '',
        qinshuxingming: '',
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.laorenzhanghao = true;
          ...
          if(o=='qinshuxingming'){
            this.ruleForm.qinshuxingming = obj[o];
	    this.ro.qinshuxingming = true;
            continue;
          }
          if(o=='xingbie'){
	    ...
	    this.ro.lianxifangshi = true;
          ...
          if(o=='yulaorenguanxi'){
            this.ruleForm.yulaorenguanxi = obj[o];
	    this.ro.yulaorenguanxi = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `qinshu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.qinshuCrossAddOrUpdateFlag = false;
						 this.parent.search();
