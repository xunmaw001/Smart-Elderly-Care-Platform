    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="老人账号" prop="laorenzhanghao">
          <el-select :disabled="ro.laorenzhanghao" @change="laorenzhanghaoChange" v-model="ruleForm.laorenzhanghao" placeholder="请选择老人账号">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="血压" prop="xueya">
          <el-input v-model="ruleForm.xueya" 
              placeholder="血压" clearable  :readonly="ro.xueya"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="血压" prop="xueya">
              <el-input v-model="ruleForm.xueya" 
                placeholder="血压" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="心跳" prop="xintiao">
          <el-input v-model="ruleForm.xintiao" 
              placeholder="心跳" clearable  :readonly="ro.xintiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="心跳" prop="xintiao">
              <el-input v-model="ruleForm.xintiao" 
                placeholder="心跳" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.jiankangbaogao" label="健康报告" prop="jiankangbaogao">
          <file-upload
          tip="点击上传健康报告"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jiankangbaogao" label="健康报告" prop="jiankangbaogao">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.jiankangbaogao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="添加时间" prop="tianjiashijian">
            <el-date-picker
                ...
                type="date"
                :readonly="ro.tianjiashijian"
                placeholder="添加时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tianjiashijian" label="添加时间" prop="tianjiashijian">
              <el-input v-model="ruleForm.tianjiashijian" 
                placeholder="添加时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="建议" prop="jianyi">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jianyi" label="建议" prop="jianyi">
                    <span>{{ruleForm.jianyi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.tianjiashijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueya = true;
          ...
          if(o=='xintiao'){
            this.ruleForm.xintiao = obj[o];
	    this.ro.xintiao = true;
            continue;
          }
          if(o=='jiankangbaogao'){
    ...
    laorenzhanghaoChange () {
      this.$http({
        url: `follow/laoren/laorenzhanghao?columnValue=`+ this.ruleForm.laorenzhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `meirijiankang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.meirijiankangCrossAddOrUpdateFlag = false;
						 this.parent.search();
