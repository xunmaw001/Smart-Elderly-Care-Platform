<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="进货编号" prop="jinhuobianhao">
            <el-input v-model="ruleForm.jinhuobianhao" 
                placeholder="进货编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jinhuobianhao" label="进货编号" prop="jinhuobianhao">
              <el-input v-model="ruleForm.jinhuobianhao" 
                placeholder="进货编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="进货单价" prop="jinhuodanjia">
          <el-input v-model="ruleForm.jinhuodanjia" 
              placeholder="进货单价" clearable  :readonly="ro.jinhuodanjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="进货单价" prop="jinhuodanjia">
              <el-input v-model="ruleForm.jinhuodanjia" 
                placeholder="进货单价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="进货总价" prop="jinhuozongjia">
            <el-input v-model="jinhuozongjia"
                placeholder="进货总价" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jinhuozongjia" label="进货总价" prop="jinhuozongjia">
              <el-input v-model="ruleForm.jinhuozongjia" 
                placeholder="进货总价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
    jinhuozongjia:{
      get: function () {
        return 1*this.ruleForm.shuliang*this.ruleForm.jinhuodanjia
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jinhuobianhao'){
            this.ruleForm.jinhuobianhao = obj[o];
	    this.ro.jinhuobianhao = true;
            continue;
          }
	    ...
	    this.ro.jinhuodanjia = true;
          ...
          if(o=='jinhuozongjia'){
            this.ruleForm.jinhuozongjia = obj[o];
	    this.ro.jinhuozongjia = true;
            continue;
          }
          if(o=='jinhuoshijian'){
    ...
    // 提交
    onSubmit() {
        this.ruleForm.jinhuozongjia = this.jinhuozongjia
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shangpinjinhuo/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shangpinjinhuoCrossAddOrUpdateFlag = false;
						 this.parent.search();
