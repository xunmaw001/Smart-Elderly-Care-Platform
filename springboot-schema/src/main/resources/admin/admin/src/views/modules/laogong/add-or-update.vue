<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作年龄" prop="gongzuonianling">
          <el-input v-model="ruleForm.gongzuonianling" 
              placeholder="工作年龄" clearable  :readonly="ro.gongzuonianling"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作年龄" prop="gongzuonianling">
              <el-input v-model="ruleForm.gongzuonianling" 
                placeholder="工作年龄" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="专长" prop="zhuanzhang">
          <el-input v-model="ruleForm.zhuanzhang" 
              placeholder="专长" clearable  :readonly="ro.zhuanzhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="专长" prop="zhuanzhang">
              <el-input v-model="ruleForm.zhuanzhang" 
                placeholder="专长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="劳工介绍" prop="laogongjieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.laogongjieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.laogongjieshao" label="劳工介绍" prop="laogongjieshao">
                    <span v-html="ruleForm.laogongjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	nianling : false,
	tupian : false,
	gongzuonianling : false,
	zhuanzhang : false,
	laogongjieshao : false,
      },
      ruleForm: {
        laogongxingming: '',
        xingbie: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='gongzuonianling'){
            this.ruleForm.gongzuonianling = obj[o];
	    this.ro.gongzuonianling = true;
            continue;
          }
          if(o=='zhuanzhang'){
            this.ruleForm.zhuanzhang = obj[o];
	    this.ro.zhuanzhang = true;
            continue;
          }
          if(o=='laogongjieshao'){
            this.ruleForm.laogongjieshao = obj[o];
	    this.ro.laogongjieshao = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.laogongjieshao = this.ruleForm.laogongjieshao.replace(reg,'../../../springcloud8w982/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `laogong/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.laogongCrossAddOrUpdateFlag = false;
						 this.parent.search();
