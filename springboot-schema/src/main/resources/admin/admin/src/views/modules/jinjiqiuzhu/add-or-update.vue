  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.qiuzhushijian" label="求助时间" prop="qiuzhushijian">
              <el-input v-model="ruleForm.qiuzhushijian" 
                placeholder="求助时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jinjiqiuzhu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jinjiqiuzhuCrossAddOrUpdateFlag = false;
						 this.parent.search();
