<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="老人手机" prop="laorenshouji">
          <el-input v-model="ruleForm.laorenshouji" 
              placeholder="老人手机" clearable  :readonly="ro.laorenshouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="老人手机" prop="laorenshouji">
              <el-input v-model="ruleForm.laorenshouji" 
                placeholder="老人手机" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="礼品" prop="lipin">
          <el-input v-model="ruleForm.lipin" 
              placeholder="礼品" clearable  :readonly="ro.lipin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="礼品" prop="lipin">
              <el-input v-model="ruleForm.lipin" 
                placeholder="礼品" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.lipintupian" label="礼品图片" prop="lipintupian">
          <file-upload
          tip="点击上传礼品图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.lipintupian?ruleForm.lipintupian:''"
          @change="lipintupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.lipintupian" label="礼品图片" prop="lipintupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.lipintupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="发放时间" prop="fafangshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fafangshijian" label="发放时间" prop="fafangshijian">
              <el-input v-model="ruleForm.fafangshijian" 
                placeholder="发放时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发放人" prop="fafangren">
          <el-input v-model="ruleForm.fafangren" 
              placeholder="发放人" clearable  :readonly="ro.fafangren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发放人" prop="fafangren">
              <el-input v-model="ruleForm.fafangren" 
                placeholder="发放人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="发放事由" prop="fafangshiyou">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="发放事由"
                  v-model="ruleForm.fafangshiyou" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fafangshiyou" label="发放事由" prop="fafangshiyou">
                    <span>{{ruleForm.fafangshiyou}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.laorenxingming = true;
          ...
          if(o=='laorenshouji'){
            this.ruleForm.laorenshouji = obj[o];
	    this.ro.laorenshouji = true;
            continue;
          }
          if(o=='jifen'){
	    ...
	    this.ro.jifen = true;
          ...
          if(o=='lipin'){
            this.ruleForm.lipin = obj[o];
	    this.ro.lipin = true;
            continue;
          }
          if(o=='lipintupian'){
            this.ruleForm.lipintupian = obj[o];
	    this.ro.lipintupian = true;
            continue;
          }
          if(o=='fafangshijian'){
	    ...
	    this.ro.fafangshijian = true;
          ...
          if(o=='fafangren'){
            this.ruleForm.fafangren = obj[o];
	    this.ro.fafangren = true;
            continue;
          }
          if(o=='fafangshiyou'){
            this.ruleForm.fafangshiyou = obj[o];
	    this.ro.fafangshiyou = true;
            continue;
          }
        }
	...
	if(this.ruleForm.lipintupian!=null) {
		this.ruleForm.lipintupian = this.ruleForm.lipintupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.jifen = objcross.jifen - this.ruleForm.jifen
	      if(objcross.jifen<0){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `lipinfafang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.lipinfafangCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    lipintupianUploadChange(fileUrls) {
	this.ruleForm.lipintupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
