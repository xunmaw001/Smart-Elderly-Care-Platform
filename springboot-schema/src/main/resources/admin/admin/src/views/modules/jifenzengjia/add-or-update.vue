<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="增加时间" prop="zengjiashijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.zengjiashijian" 
                type="datetime"
                :readonly="ro.zengjiashijian"
                placeholder="增加时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zengjiashijian" label="增加时间" prop="zengjiashijian">
              <el-input v-model="ruleForm.zengjiashijian" 
                placeholder="增加时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="增加事由" prop="zengjiashiyou">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="增加事由"
                  v-model="ruleForm.zengjiashiyou" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zengjiashiyou" label="增加事由" prop="zengjiashiyou">
                    <span>{{ruleForm.zengjiashiyou}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.zengjiashijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jifen = true;
          ...
          if(o=='zengjiashijian'){
            this.ruleForm.zengjiashijian = obj[o];
	    this.ro.zengjiashijian = true;
            continue;
          }
          if(o=='zengjiashiyou'){
            this.ruleForm.zengjiashiyou = obj[o];
	    this.ro.zengjiashiyou = true;
            continue;
          }
        }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jifenzengjia/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jifenzengjiaCrossAddOrUpdateFlag = false;
						 this.parent.search();
